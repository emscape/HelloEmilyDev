...
# This is a wrapper script that calls the main publish-new-blog-posts.ps1 script

# Get the directory of this script
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$RootDir = Split-Path -Parent $ScriptDir
$PublishScriptPath = Join-Path -Path $RootDir -ChildPath "js\publish-new-blog-posts.ps1"
