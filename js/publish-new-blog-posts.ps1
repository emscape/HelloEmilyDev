...
foreach ($file in $files) {
    ...
    # Run the md-to-blog.ps1 script with the appropriate parameters
    $mdToBlogPath = Join-Path -Path $ScriptDir -ChildPath "md-to-blog.ps1"
